...
const OFFICIAL_SCHEMES = [
  ...
  },
  {
    ...
    title_ur: 'وزیر اعلیٰ پنجاب سولر ٹیوب ویل اسکیم',
    title_en: 'CM Punjab Solar Tube-well Subsidy Scheme',
    icon: '☀️',
    category: 'آبپاشی و شمسی توانائی سبسڈی',
    subsidy_amount: '₨500,000 تا ₨1,000,000 تک سرکاری رعایت',
    loan_limit: '10 تا 20 کلو واٹ سولر سسٹمز پر 50٪ رعایت',
    deadline: 'درخواستیں فعال ہیں',
    sms_code: '8070',
    portal_url: 'https://agripunjab.gov.pk/solar-tubewell',
    eligibility_ur: 'پنجاب کے کسان جن کے پاس 5 تا 25 ایکڑ رقبہ اور فعال ڈیزل/بجلی ٹیوب ویل موجود ہو۔',
    description_ur: 'مہنگے ڈیزل اور بجلی سے چھٹکارا: 10kW سسٹم پر 5 لاکھ، 15kW پر 7.5 لاکھ اور 20kW پر 10 لاکھ روپے کی یکمشت حکومتی سبسڈی۔',
    benefits: ['ڈیزل کے اخراجات میں 100٪ تک کمی', '50٪ حکومتی مالی معاونت', 'وارنٹی شدہ ٹائر 1 سولر پینلز اور انورٹرز']
  }
];
