...
app.listen(PORT, () => {
  ...
  console.log(`   Supabase   : ${supabaseReady  ? '✅ configured' : '⚠️  not set — dev mode'}`);
  console.log(`   JWT Secret : ${jwtConfigured  ? '✅ configured' : '⚠️  using dev fallback — set JWT_SECRET in production'}`);
});
